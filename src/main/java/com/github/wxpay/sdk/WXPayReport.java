...
public class WXPayReport {
    ...
    public static class ReportInfo {
        ...
        private String sdk = com.github.wxpay.sdk.WXPayConstants.WXPAYSDK_VERSION;
    ...
    private WXPayReport(final WXPayConfig config) {
        ...
        if (config.shouldAutoReport()) {
            com.github.wxpay.sdk.WXPayUtil.getLogger().info("report worker num: {}", config.getReportWorkerNum());
                    ...
                    public void run() {
                        while (true) {
                            ...
                            try {
                                ...
                                com.github.wxpay.sdk.WXPayUtil.getLogger().info("get first report msg: {}", firstMsg);
                                String msg = null;
                                sb.append(firstMsg); //会阻塞至有消息
                                int remainNum = config.getReportBatchSize() - 1;
                                for (int j=0; j<remainNum; ++j) {
                                    com.github.wxpay.sdk.WXPayUtil.getLogger().info("try get remain report msg");
                                    // msg = reportMsgQueue.poll();  // 不阻塞了
                                    msg = reportMsgQueue.take();
                                    com.github.wxpay.sdk.WXPayUtil.getLogger().info("get remain report msg: {}", msg);
                                    if (msg == null) {
                                        break;
                                    }
                                    else {
                                ...
                                com.github.wxpay.sdk.WXPayUtil.getLogger().warn("report fail. reason: {}", ex.getMessage());
                            }
                        }
                    }
                });
    ...
    public void report(String uuid, long elapsedTimeMillis,
        ...
        long currentTimestamp = com.github.wxpay.sdk.WXPayUtil.getCurrentTimestamp();
        ...
        com.github.wxpay.sdk.WXPayUtil.getLogger().info("report {}", data);
        if (data != null) {
    ...
    private static String httpRequest(String data, int connectTimeoutMs, int readTimeoutMs) throws Exception{
        ...
        httpPost.addHeader("User-Agent", com.github.wxpay.sdk.WXPayConstants.USER_AGENT);
